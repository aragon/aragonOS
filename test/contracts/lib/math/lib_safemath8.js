...
contract('SafeMath8 lib test', () => {
  ...
  it('fails if multplication overflows', async () => {
    const a = 16
    const b = 16
    await assertRevert(safeMath8Mock.mulExt(a, b))
  })
  ...
  it('fails dividing by zero', async () => {
    const a = 123
    const b = 0
    await assertRevert(safeMath8Mock.divExt(a, b))
  })
  ...
  it('fails if subtraction underflows', async () => {
    const a = 123
    const b = 124
    await assertRevert(safeMath8Mock.subExt(a, b))
  })
  ...
  it('fails if addition overflows', async () => {
    const a = 128
    const b = 128
    await assertRevert(safeMath8Mock.addExt(a, b))
  })
  ...
  it('fails modulo dividing by zero', async () => {
    const a = 123
    const b = 0
    await assertRevert(safeMath8Mock.modExt(a, b))
  })
})
