...
contract GrantableStock is Stock {
  ...
  function grantVestedStock(address _to, uint256 _value, uint64 _start, uint64 _cliff, uint64 _vesting) onlyCompany {
  ...
  function revokeStockGrant(address _holder, uint _grantId) onlyCompany {
