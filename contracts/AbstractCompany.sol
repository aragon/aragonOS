...
contract AbstractCompany {
  ...
  // gas function registerIncome(string concept) payable public returns (bool);

  // gas function setAccountingSettings(uint256 budget, uint64 periodDuration, uint256 dividendThreshold);
