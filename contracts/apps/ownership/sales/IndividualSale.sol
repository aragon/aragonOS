...
contract IndividualSale is TokenSale {
  ...
  function instantiate(address _dao, OwnershipApp _ownershipApp, ERC20 _raiseToken, ERC20 _saleToken, address _buyer, uint _buyAmount, uint _tokensOffered, uint64 _expireBlock) {
