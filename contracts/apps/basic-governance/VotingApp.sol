...
contract VotingApp is IVotingApp, Application {
    ...
    function createVote(
        ...
        uint64 _voteStartsBlock,
        uint64 _voteEndsBlock,
        uint256 _targetYayPct
        )
    onlyDAO 
    {
        ...
        require(_targetYayPct <= PCT_BASE);
...
>>>>>>> upstream/master
    ...
    function transitionToVotingState(Vote storage vote) internal {
        ...
        vote.targetYays = vote.totalQuorum * vote.targetYayPct / PCT_BASE;
