...
<<<<<<< HEAD
    uint8 constant KERNAL_PRIMARY_KEY = 0x01; // TODO: move ether token logic completely here
    ...
    function getEtherToken() internal returns (address) {
        return address(storageGet(sha3(KERNAL_PRIMARY_KEY, 0x02)));
    }
