...
contract APMRegistryFactory is APMInternalAppNames {
    ...
    /**
    * @dev Create a new instance of Aragon Package Manager (APM) Factory. Needs either one ENS or ENSFactory.
    * @notice Create a new instance of Aragon Package Manager (APM) Factory. Sets DAO Factory: `_daoFactory`, APM Registry: `_registryBase`,  APM Repository: `_repoBase`, ENS Subdomain registrar: `_ensSubBase`, ENS: `_ens`. If 0x0, ENS is generated by the ENS Factory: `_ensFactory`
    * @param _daoFactory DAO Factory
    * @param _registryBase APM Registry
    * @param _repoBase APM Repository
    * @param _ensSubBase ENS Subdomain Registrar
    * @param _ens ENS
    * @param _ensFactory ENS Factory
    */
    constructor(
    ...
    /**
    * @dev Create a new instance of Aragon Package Manager (APM).
    * @notice Create a new instance of Aragon Package Manager (APM). Subdomain is created for the APM app with parent node `_tld` and label `_label` is created. Address `_root` is given following permissions: 1. Create names in ENS Subdoman Registrar, 2. Create versions in APM, 3. Permission manager in APM's ACL.
